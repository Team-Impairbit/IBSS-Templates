	...
	<div id="<?php echo esc_attr($portfolio_id) ?>" class="gallery-section">
		...
		<div class="row">
			<div class="col-md-12 text-center">
				<div class="gallery-filter hover-primary mb-70" data-active="<?php echo esc_attr($active) ?>">
				
						<button class="noto-font-700" data-filter="*"><?php printf(_x('%s', 'All text', 'landpick'), landpick_get_option('portfolio_all_text', 'See All')); ?></button>
						<?php 
