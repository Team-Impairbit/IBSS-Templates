...
function landpick_iconpicker_styles() {
    wp_register_style( 'fontawesome', LANDPICK_URI. '/css/fontawesome.css', false, LANDPICK_VERSION, 'all' );    
    wp_register_style( 'flaticon', LANDPICK_URI. '/css/flaticon.css', false, LANDPICK_VERSION );
    wp_register_style( 'tonicons', LANDPICK_URI. '/css/tonicons.css', false, LANDPICK_VERSION );
}
...
function landpick_admin_styles( ) {
    wp_enqueue_style( 'landpick-admin-style', LANDPICK_URI . '/admin/assets/css/style.css', false, LANDPICK_VERSION, 'all' );
    wp_enqueue_style( 'landpick-vc-admin', LANDPICK_URI . '/admin/assets/css/vc-admin.css', false, LANDPICK_VERSION, 'all' );   
...
function landpick_admin_scripts( ) {
    wp_enqueue_media();
    wp_enqueue_script( 'v4-shims', LANDPICK_URI .'/js/fa-v4-shims.min.js', array( 'jquery' ), LANDPICK_VERSION, true );
   
    wp_register_script( 'landpick-scripts', LANDPICK_URI . '/admin/assets/js/scripts.js', array(
         'jquery' 
    ), LANDPICK_VERSION, false );
