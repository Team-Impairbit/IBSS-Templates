...
add_filter( 'landpick_theme_options', 'landpick_theme_options_callback', 100, 2 );
function landpick_theme_options_callback( $options, $section ){
        return apply_filters( 'perch_modules/theme_options', $options, $section ); 
}

add_filter( 'perch_modules/animation_style/std', 'landpick__animation_style_std' );
function landpick__animation_style_std(){
    return landpick_get_option( 'default_animation', 'fadeInUp' );
}
...
function landpick_login_logo( $css ) {
    ...
    $css = '<style>body.login div#login h1 a {
...
add_filter('perch_modules/vc_admin_view', 'landpick_vc_admin_view' );
function landpick_vc_admin_view($output){    
    $output = landpick_get_option('vc_admin_view', 'full');
    return $output;
} 