...
load_template(LANDPICK_DIR . "/admin/framework/meta-boxes/meta-boxes-team-settings.php") ;
...
function landpick_get_metabox_group_std($settings = array()){
    ...
    foreach ($settings as $key => $value) {
        ...
        $id = $value['id']; 
        $std = isset($landpick_options[$id])? $landpick_options[$id] : $value['std'];
