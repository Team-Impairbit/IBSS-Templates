...
if( function_exists('landpick_quick_contact_form_options') ):
Redux::setSection( $opt_name, array(
    'title'  => __( 'Quick contact form', 'landpick' ),
    'id'     => 'footer-quick-contactform-settings',
    'subsection'       => true,
    'customizer_width' => '600px',
    'fields' => landpick_quick_contact_form_options(),        
) );
endif;

if( function_exists('landpick_backtotop_options') ):
Redux::setSection( $opt_name, array(
    'title'  => esc_attr__( 'Back to top', 'landpick' ),
    'id'     => 'back-to-top-settings',
    'subsection'       => true,
    'customizer_width' => '600px',
    'fields' => landpick_backtotop_options(),        
) );
endif;
...
if( function_exists('landpick_portfolio_options') ):
Redux::setSection( $opt_name, array(
    'title'            => __( 'Portfolio Options', 'landpick' ),
    'id'               => 'portfolio',
    'icon'  => 'dashicons dashicons-images-alt',
    'fields'           => landpick_portfolio_options(),
));
endif;

if( function_exists('landpick_team_options') ):
Redux::setSection( $opt_name, array(
    'title'            => __( 'Team Options', 'landpick' ),
    'id'               => 'team',
    'icon'  => 'dashicons dashicons-groups',
    'fields'           => landpick_team_options(),
));
endif;
...
if (function_exists('landpick_404_options')) {
    Redux::setSection( $opt_name, array(
