...
function landpick_comment_form( $args = array(), $post_id = null ) {
	...
	$fields   =  array(
		...
		'website'  => '<div id="post-website" class="col-md-12"><p>' . esc_attr__( 'Website', 'landpick' ) .'</p><input id="website" class="form-control name" placeholder="' . esc_attr__( 'Website', 'landpick' ) . '" name="website" ' . ( $html5 ? 'type="text"' : 'type="text"' ) . ' value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30"/></div>'
	);
