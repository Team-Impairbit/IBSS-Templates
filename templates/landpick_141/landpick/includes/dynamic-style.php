...
function landpick_background_css($option_id, $selector = '') {
    ...
    $output     = landpick__background_css($background, $selector);
    
    return $output;
}
function landpick__background_css($background = array(), $selector = '') {
    $output = '';
    $properties = '';
...
function landpick_get_dynamic_header_css() {
  ...
  $css .= landpick_background_css('preloader_bg', '#loader-wrapper');
