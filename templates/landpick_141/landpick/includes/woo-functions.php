    ...
    function woocommerce_content( ) {
        if ( is_singular( 'product' ) ) {
			...
			<div class="row">
                ...
                while ( have_posts() ):
                    the_post(); ?>
						<div class="product-item col-md-<?php echo ( 12 / $column ); ?> mb-50">
...
if ( ! function_exists( 'woocommerce_output_product_categories' ) ) {
    ...
    function woocommerce_output_product_categories( $args = array() ) {
        ...
        echo landpick_context_args($args['before']); // WPCS: XSS ok.
        $count  = 1;
        $column = landpick_loop_columns();
        ...
        echo landpick_context_args($args['after']); // WPCS: XSS ok.
 ...
 * Image Flipper class
 */
if ( ! class_exists( 'Landpick_WC_Image_Flipper' ) ) {
    class Landpick_WC_Image_Flipper {
    ...
    $Landpick_WC_Image_Flipper = new Landpick_WC_Image_Flipper();
}
